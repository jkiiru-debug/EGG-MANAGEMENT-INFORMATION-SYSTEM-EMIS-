...
class MathCaptcha:
    """
    Math CAPTCHA — stores answer in st.session_state so it
    survives Streamlit reruns. No in-memory dict needed.
    """
    ...
    def generate(self, session_id: str) -> Dict[str, Any]:
        ...
        # Store in session_state — the only store that survives reruns
    ...
    def verify(self, session_id: str, user_answer: str) -> Dict[str, Any]:
        ...
        return {'success': False, 'error': f'Wrong answer. ({attempts}/5 attempts)'}
...
class DatabaseManager:
    ...
    def _get_connection(self) -> sqlite3.Connection:
        # Probe existing connection — stale connections crash on Streamlit Cloud
    ...
    def transaction(self):
        ...
        try:
            ...
            try:
                ...
                # Connection is dead — reset so next call gets a fresh one
                self._local.conn = None
            raise e
