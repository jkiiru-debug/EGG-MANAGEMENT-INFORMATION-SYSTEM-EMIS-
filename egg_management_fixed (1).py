...
class DatabaseManager:
    ...
    def _get_connection(self) -> sqlite3.Connection:
        # Probe existing connection — stale connections cause ProgrammingError on Streamlit Cloud
    ...
    def transaction(self):
        ...
        try:
            ...
            try:
                ...
                # Connection already closed/broken — reset so next call gets a fresh one
                self._local.conn = None
            raise e
