...
def render_math_captcha(captcha: MathCaptcha):
    ...
    with col3:
        if st.button("🔄", help="Refresh CAPTCHA"):
    ...
    with col2:
        ...
        with tab1:
            with st.form("login_form", clear_on_submit=False):
                ...
                st.markdown("---")
                st.caption("🧮 Security Verification - Solve the math problem")
                ...
                if submit:
                    if not captcha_answer:
                        ...
                        st.session_state["login_error"] = "⚠️ Please solve the math problem above."
                        st.stop()
        ...
        with tab2:
            with st.form("register_form"):
                ...
                submit_reg = st.form_submit_button("Submit Request")
